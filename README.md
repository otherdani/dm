...
---
### Custom Rules: 
Add your own bespoke rules on top of pre-set guidelines.
### Zero Backend:
Built using pure HTML, JavaScript, and Tailwind CSS.
### Short & Shareable URLs:
State persistence is handled via URL hash fragments (⁠#⁠), keeping your generated link neat and ready for your Instagram, TikTok, X (Twitter), or Discord bio.
